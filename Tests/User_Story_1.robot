...
Variables       ../TestData/User_Story_1.yml
...
TC_2: Insert a list of records and validate the response
    [Documentation]    In this test case will try to add list of json and validate the error response.
    [Tags]    regression
    Make a POST API Request with    ${Base_URL}    calculator/insert
    ...    ${Request_header}
    ...    ${Multiple_records}
    Verify the API Response Code is    400
    Verify the API Response body contains Error Message    Bad Request
